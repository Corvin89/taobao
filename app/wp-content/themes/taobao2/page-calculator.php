        ...
        <div class="t1">
            <div class="it-line">
                ...
                <div class="description">
                    <p><b>«АЛТАН»</b> - занимается ежедневной отправкой мелкого груза по территории Дальнего Востока.
                        Уже более 10 лет компания специализируется в области перевозки сборного груза от 1 кг. </p>

                    <p class="url"><a href="#">http://www.tkaltan.ru</a> <a href="#"><img src="<?php bloginfo('template_directory'); ?>/img/gree1.gif" alt=""
                                                                                          title=""/></a> <a
                        href="#"><img src="<?php bloginfo('template_directory'); ?>/img/gree-2.gif" alt="" title=""/></a> <a href="#"><img src="<?php bloginfo('template_directory'); ?>/img/gree3.gif"
                                                                                                  alt="" title=""/></a>
                    </p>
                </div>
            </div>
    ...
    <div class="more">
        ...
        <table cellpadding="0" class="" cellspacing="0">
            <tr class="item1">
                ...
                <td class="item1">215 юаней (1161 руб)</td>
                <td class="item2">Курс Юаня 5.4 руб</td>
            </tr>
            <tr>
                <th class="item">Стоимость доставки до склада в Китае:</th>
                <td class="item1">27 юаней (146 руб)</td>
                <td class="item2">Курс Юаня 5.4 руб</td>
            </tr>
            <tr class="item1">
                <th class="item">Вес товара:</th>
                <td class="item1">35 кг</td>
                <td class="item2">Приблизительно</td>
            </tr>
            <tr>
                <th class="item">Cтоимость доставки из Китая в Россию:</th>
                <td class="item1">10500 рублей</td>
                <td class="item2">300 руб за кг</td>
            </tr>
            <tr class="item1">
                <th class="item">Комиссия за услуги нашей компании:</th>
                <td class="item1">174 рублей</td>
                <td class="item2">15% от стоимости товара</td>
            </tr>
        </table>
        <table cellspacing="0" cellpadding="0">
            ...
            <tr>
                ...
                <td>620 рублей</td>
                <td>от 14 до 15 дней <br/> (с учетом 14 дней <br/> до России)</td>
                <td><span>12601 рублей</span></td>
            </tr>
            <tr class="item1">
                <td class="title-first">
